  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6">Our Story</h1>
          <p className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto mb-8">
            Discover how Carpbook became the ultimate platform for carp fishing enthusiasts
          </p>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
            ...
            there's a place for you in the Carpbook community.
          </p>
          <Link
            to="/register"
